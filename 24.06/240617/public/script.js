...
const slidePagers= document. querySelectorAll(".slide_pager span"); //slide pager
const slideImg= document. querySelector(".slide_img"); //slide image
...
slideImg.style.backgroundImage= `url(//ecimg.cafe24img.com/pg1108b56726389014/jann21/240621Chef/${pics[i]})`;
slidePagers[0].classList.add("active");

//실제 이미지를 변경시켜주는 실행 함수
const updateSlide=(i)=>{
